...
const defaultSubjects: Subject[] = [
  { id: 1, unit: 'FIT1045', mark: '80', credits: '6' },
  { id: 2, unit: 'MAT1830', mark: '75', credits: '6' },
  { id: 3, unit: 'ENG1005', mark: '70', credits: '6' },
];
...
export default function WAMCalculator() {
  ...
  const addSubject = () => {
    setSubjects(prev => [...prev, { id: nextId++, unit: '', mark: '', credits: '6' }]);
  };
  ...
  const reset = () => {
    setSubjects([
      { id: 1, unit: '', mark: '', credits: '6' },
      { id: 2, unit: '', mark: '', credits: '6' },
    ]);
  };
