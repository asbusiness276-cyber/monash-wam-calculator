    ...
    return (
      ...
      >
        ...
        <div className="mb-1.5 flex justify-center">
          <span className="text-[10px] font-black uppercase tracking-wider text-amber-500 bg-amber-500/10 px-2 py-0.5 rounded flex items-center gap-1 w-max border border-amber-500/20 animate-pulse">
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
        ...
        <div className="md:col-span-5 lg:col-span-5 flex flex-col justify-center">
          <span className="text-[10px] font-black uppercase tracking-wider text-amber-500 bg-amber-500/10 px-2 py-0.5 rounded flex items-center gap-1 w-max border border-amber-500/20 animate-pulse mb-2.5">
            ⚡ FLASH SALE - ENDING SOON
          </span>
