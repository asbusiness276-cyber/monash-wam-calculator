      ...
      <section className="max-w-3xl mx-auto px-4 pt-8 pb-4">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          <div>
            ...
            <p className="mb-3">
              Monash WAM Calculator hosts 26 free academic planning tools and 24 long-form student guides. Every
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>24 student articles on honours, scholarships, credit points, transcripts, exchange, and recovery</li>
            </ul>
          </div>
