...
const faqs = [
  {
    ...
    answer:
      'Monash maps grade bands across scales: HD 4.0 = 7.0, D 3.0 = 6.0, C 2.0 = 5.0, P 1.0 = 4.0, Fail = 0.',
  },
  {
    question: 'Is 3.5 on 4.0 equal to 6.5 on 7.0?',
    answer:
      'Band mapping uses Monash letter grades. Mid-band GPAs map to the nearest grade band — enter your value for the exact conversion.',
  },
  {
  ...
  {
    question: 'Monash official scale?',
    answer: 'Monash transcripts commonly show 4.0 GPA. The 7.0 scale is widely used for Australian comparisons.',
  },
  {
...
export default function Gpa40To70() {
  return (
    <>
      <Seo
        title="4.0 to 7.0 GPA Calculator - Australian Monash Converter (2026)"
        description="Free 4.0 to 7.0 GPA calculator using Monash grade bands. Convert US-style GPA to the Australian 7-point scale."
      ...
      <section className="bg-gradient-to-br from-rose-700 to-rose-900 text-white py-12 text-center px-4">
        ...
        <p className="text-rose-100 max-w-xl mx-auto">
          Convert GPA from the 4.0 scale to the Australian 7.0 scale using official Monash grade band mapping.
        </p>
