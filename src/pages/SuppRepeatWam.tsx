...
const suppRepeatFaqs = [
  {
    question: 'What mark do you get if you pass a Monash supplementary?',
    answer: `If you pass a supplementary assessment, your final unit result is capped at ${monashSupplementaryPassMark}% (P). You cannot score higher through supplementary.`,
  },
  {
  ...
  {
    question: 'How does repeating a unit affect Monash WAM?',
    answer:
      'Monash includes both failed and repeated unit attempts in WAM. A repeat adds another weighted entry — it does not automatically remove the first fail from your average.',
  },
  {
  ...
  {
    question: 'Is this official Monash advice?',
    answer:
      'No. This is an independent planning calculator. Always confirm supplementary eligibility, repeat enrolment rules, and official WAM with Monash student services.',
  },
];
...
export default function SuppRepeatWam() {
  return (
    <>
      <Seo
        title="Supplementary vs Repeat WAM Calculator - Monash Fail Recovery (2026)"
        description="Compare Monash supplementary pass (50% cap) vs repeating a failed unit. Free calculator shows WAM impact for fail recovery planning."
      ...
      <section className="bg-gradient-to-br from-rose-700 to-rose-900 text-white py-12 text-center px-4">
        ...
        <p className="text-rose-100 max-w-2xl mx-auto">
          Failed a unit? Compare how a Monash supplementary pass (capped at {monashSupplementaryPassMark}%) stacks up
      ...
      <section className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white">How Monash Treats Each Path</h2>
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-3 leading-relaxed">
            <p>
              ...
              with NS) get one last chance. Pass → unit becomes {monashSupplementaryPassMark}% (P). Fail → original mark
              stays.
            </p>
            <p>
              <strong className="text-gray-800 dark:text-gray-200">Repeat:</strong> you enrol again and can earn any
              mark, but Monash WAM counts <em>both</em> the failed attempt and the repeat in the credit-weighted
              average.
            </p>
            <p>
