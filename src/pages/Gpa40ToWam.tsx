...
const faqs = [
  {
    ...
    answer:
      'Enter your GPA on the 4.0 scale. Uni maps each GPA band to a WAM percentage range — e.g. 3.0 ≈ 70–79% (Distinction).',
  },
  {
    question: 'What WAM is GPA 3.5?',
    answer: '3.5 on 4.0 sits in the High Distinction band — approximately WAM 80–100 at Uni.',
  },
  {
  ...
  {
    question: 'Is this for Uni only?',
    answer:
      'Bands follow Uni coursework standards. Other universities may use different mappings — note your source institution.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Enter real unit marks in the WAM calculator once you have transcript percentages.',
  },
];
...
export default function Gpa40ToWam() {
  return (
    <>
      <Seo
        title="4.0 GPA to WAM Calculator - Uni Converter (2026)"
        description="Free 4.0 GPA to WAM calculator for Uni planning. Convert US-style GPA to approximate Uni weighted average mark ranges."
      ...
      <section className="bg-gradient-to-br from-teal-700 to-teal-900 text-white py-12 text-center px-4">
        ...
        <p className="text-teal-100 max-w-xl mx-auto">
          Convert 4.0 GPA to an approximate WAM range — ideal for transfer planning, scholarships, and comparing US-style grades.
        </p>
